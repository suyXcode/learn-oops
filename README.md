...
├──  oops/
│ └── class or objects/
│ ├── p0.py # Example of inheritance, encapsulation,
├── requirements.txt
└── README.md
...
📧 Email: [suyxcode@gmail.com](mailto:suyxcode@gmail.com)  
🔗 [GitHub](https://github.com/suyXcode) • [Medium](https://medium.com/@suyxcode) • [LinkedIn](https://linkedin.com/in/suyxcode)
